...
class Example extends React.Component {
  constructor(props) {
    ...
    let model = window.cs142models.exampleModel();
    this.state = {
      name: model.name,
      motto: model.motto,
      counter: 0,
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          <p class="cs142-example-output">{this.state.name}'s motto is: {this.state.motto}</p>
          <br></br>
          <input id="motto-input" value={this.state.motto} onChange={(evt) => this.setState({motto: evt.target.value})}></input>
        </div>
